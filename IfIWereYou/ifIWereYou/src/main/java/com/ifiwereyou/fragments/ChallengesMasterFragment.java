...
import com.ifiwereyou.objects.ChallengesProvider;
...
//This is the fragment holding the contacts and corresponding (recent) challenges
public class ChallengesMasterFragment extends ListFragment {

	public static final String pageTitle = "Challenges";

    private List<Challenge> mChallenges;
    private ChallengesProvider challengesProvider = new ChallengesProvider();

	@Override
	public void onActivityCreated(Bundle savedInstanceState) {
		super.onActivityCreated(savedInstanceState);
        mChallenges = challengesProvider.getChallenges();
    ...
    //TODO remove after final refactoring
    //created provider class ChallengesProvider
    //target: implementation of observer pattern --> update challenges after modifications
